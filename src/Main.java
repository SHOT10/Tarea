...
public class Main {
    public static void main(String[] args) {
        ...
        int operacion, eligunafigu;
        double result, radi, diamet, lad, altu, base, lado1, lado2, lado3, semiPerime, longi, anchu;
        int contador = 0;
            ...
            switch (eligunafigu) {
                ...
                case 3:
                    if (operacion == 1) {
                        ...
                        System.out.print("Ingrese la base y la altura del triángulo (separados por un espacio): ");
                        base = scanner.nextDouble();
                        altu = scanner.nextDouble();
                        result = 0.5 * base * altu;
                        System.out.println("\nEl área del triángulo es: " + result);
                    } else {
                        System.out.print("Ingrese la longitud de los tres lados del triángulo (separados por un espacio): ");
                        lado1 = scanner.nextDouble();
                        lado2 = scanner.nextDouble();
                        lado3 = scanner.nextDouble();
                        semiPerime = (lado1 + lado2 + lado3) / 2;
                ...
                case 4:
                    if (operacion == 1) {
                        ...
                        System.out.print("Ingrese la longitud y el ancho del rectángulo (separados por un espacio): ");
